...
> [!WARNING]
> 本项目为 90% AI + 10% 人工开发完成，仅供技术研究参考，不接受任何 Issue。欢迎自行 Fork / 二次开发，商用请标明出处。

> [!NOTE]
> **作者说：** 我不认同 AugmentCode 的商业理念和技术方向，该公司对用户态度傲慢且漠视需求，没有任何契约精神，产品没有经过任何测试，最新推出的 Intent 更是垃圾产物。它的最佳结局就是被市场收购然后边缘化亦或是倒闭，希望 Augment 的产品和高层能够意识到，你的 ACE 早已不是你的护城河，尽早关闭公司拿钱去享受人生吧！
